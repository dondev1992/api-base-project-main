...
//
//import static io.catalyte.training.paymentprocessor.domains.payment.Demographic.Men;
...
//    payment = new Payment(BigDecimal.ONE, "a", "a", Men, "a", "a", "a");
//    payment = productRepository.save(payment);
//  }
//
//  @Test
//  public void getProductByIdStatusTest() throws Exception {
//    mockMvc.perform(get("/products/" + payment.getId()))
